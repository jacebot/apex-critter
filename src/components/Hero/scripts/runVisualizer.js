const runVisualizerBackground = () => {
  ...
  let chune = require('../../../assets/chune-loop.mp3');
  let chuneName = 'Apex Media Loop';
  ...
  function updateSongText(newText) {
    songText = newText;
    if (canvasContext) textSize = canvasContext.measureText(songText);
  }
  ...
  function setupAudioApi(audioElement) {
    ...
    audioAnalyserNode.fftSize = drawPitch
      ? displayBins * 8
      : displayBins * 2;
    multiplier =
...
export default runVisualizerBackground
